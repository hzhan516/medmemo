...
func InitializeApp() (*App, func(), error) {
	wire.Build(
		...
		wire.Bind(new(domainRepo.KnowledgeRepository), new(*repository.KnowledgeRepoSQLite)),
		...
		repository.DialogueRepoSet,
		repository.AuditLogRepoSet,
		wire.Bind(new(domainRepo.RawDialogueRepository), new(*repository.DialogueRepoSQLite)),
		...
		wire.Bind(new(port.StandardNERDetector), new(*detector.ONNXNERDetector)),
		wire.Bind(new(port.StrictNERDetector), new(*detector.StrictONNXNERDetector)),
